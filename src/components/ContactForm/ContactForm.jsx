                ...
                <div className={s.container}>
                    ...
                    <div className={s.contactForm}>
                        ...
                        <div className={s.buttonBlock}>
                            <Button className={s.button} type="default" onClick={submitMessage}>Отправить</Button>
                        </div>
                    </div>}
                        {!contactBlock &&
                        <div className={s.answer}>
                            <div>Спасибо за проявленный интерес, мы обязательно с Вами свяжемся!</div>
                            <Button className={s.button} type="default" onClick={returnContactForm}>Ещё письмо</Button>
                        </div>}
                    </>}
                </div>
            </div>
